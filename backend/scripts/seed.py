...
CAFE_SEEDS: tuple[CafeSeed, ...] = (
    ...
    CafeSeed("Bugis Courtyard Cafe", "All-day dining room with a shaded courtyard layout.", "Bugis", "https://placehold.co/320x192/f3eadf/7a4b2f/png?text=Bugis+Courtyard%0ACafe&font=playfair-display"),
    CafeSeed("Bugis Junction Roasters", "Mall-facing coffee bar focused on fast espresso service.", "Bugis", None),
    CafeSeed("Bugis Lantern Coffee", "Late-night dessert and coffee concept near the arts district.", "Bugis", "https://placehold.co/320x192/2f2430/f4c95d/png?text=Bugis+Lantern%0ACoffee&font=playfair-display"),
    CafeSeed("Orchard Glasshouse", "Premium flagship outlet with brunch-heavy menu rotations.", "Orchard", "https://placehold.co/320x192/e8f3eb/466c52/png?text=Orchard%0AGlasshouse&font=playfair-display"),
    CafeSeed("Orchard Pocket Cafe", "Small-format espresso bar built for weekday office rushes.", "Orchard", None),
    CafeSeed("Orchard Terrace Kitchen", "Casual sit-down cafe with rooftop seating and pastries.", "Orchard", "https://placehold.co/320x192/f1e7da/7f6446/png?text=Orchard+Terrace%0AKitchen&font=playfair-display"),
    CafeSeed("Orchard Weekend Social", "Lifestyle cafe that leans into family weekend traffic.", "Orchard", None),
    CafeSeed("Raffles Atrium Cafe", "Corporate lunch location serving high-volume weekday crowds.", "Raffles Place", "https://placehold.co/320x192/e7edf6/405b7b/png?text=Raffles+Atrium%0ACafe&font=playfair-display"),
    CafeSeed("Raffles Exchange Coffee", "Transit-adjacent kiosk with strong breakfast trade.", "Raffles Place", None),
    CafeSeed("Raffles Market Table", "Polished business district cafe with plated lunch service.", "Raffles Place", "https://placehold.co/320x192/efe7f6/5a4f7d/png?text=Raffles+Market%0ATable&font=playfair-display"),
    ...
    CafeSeed("Tampines East Roast", "Warm cafe with bakery case and extended evening hours.", "Tampines", "https://placehold.co/320x192/f4e6d8/a05b2a/png?text=Tampines+East%0ARoast&font=playfair-display"),
    CafeSeed("Tampines Hub Kitchen", "Large-format store geared toward community events.", "Tampines", None),
    CafeSeed("Tampines Park Coffee", "Casual outlet beside the park connector trail.", "Tampines", "https://placehold.co/320x192/e6f0e8/4f7a57/png?text=Tampines+Park%0ACoffee&font=playfair-display"),
    CafeSeed("Jurong Central Cafe", "Reliable lunch spot serving office parks in the west.", "Jurong East", None),
    CafeSeed("Jurong Lakeside Coffee", "Scenic cafe with relaxed seating and longer dwell times.", "Jurong East", "https://placehold.co/320x192/e4f1f1/2f6f73/png?text=Jurong+Lakeside%0ACoffee&font=playfair-display"),
    CafeSeed("Jurong Platform Brew", "Transit-linked bar designed for high-throughput service.", "Jurong East", None),
    CafeSeed("Jurong Tech Yard", "Industrial-park concept with strong breakfast and lunch demand.", "Jurong East", "https://placehold.co/320x192/e8eaee/56606f/png?text=Jurong+Tech%0AYard&font=playfair-display"),
    CafeSeed("Paya Lebar Commons", "Mixed-use development cafe balancing dine-in and takeaway.", "Paya Lebar", "https://placehold.co/320x192/f0e8f3/7b5b8d/png?text=Paya+Lebar%0ACommons&font=playfair-display"),
    CafeSeed("Paya Lebar Loft", "Modern mezzanine cafe with collaborative seating.", "Paya Lebar", None),
    CafeSeed("Paya Lebar Market Cafe", "Neighbourhood-forward concept with local snack pairings.", "Paya Lebar", "https://placehold.co/320x192/f5e9db/9b6b35/png?text=Paya+Lebar%0AMarket+Cafe&font=playfair-display"),
